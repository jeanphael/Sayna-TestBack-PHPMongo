...
class Home extends BaseController
{
	...
	public function register()
	{
		...
		$insertOneResult = $collection->insertOne(['token'=>'','firstname'=>$firstname,'lastname'=>$lastname,'email'=>$email,'password'=>$pwdCrypt,'date_naissance'=>$date_naissance,'sexe'=>$sexe,'createdAt'=>time(),'updateAT'=>time(),'subscription'=>'']);
